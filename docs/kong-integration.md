...
### 2. Deploy SentryFlow (Initial - Creates ConfigMap)

Deploy SentryFlow with Kong receiver enabled. This creates the `sentryflow-log-plugin` ConfigMap in the 'kong' namespace containing the plugin Lua code.
