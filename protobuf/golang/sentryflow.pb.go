...
const file_sentryflow_proto_rawDesc = "" +
	...
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01:\x02\x18\x01\"\x95\x02\n" +
	"\bAPIEvent\x12.\n" +
	...
	"\bprotocol\x18\a \x01(\tR\bprotocol\"\xf6\x01\n" +
	"\bMetadata\x12\x1d\n" +
	"\n" +
	...
	"\x10receiver_version\x18\a \x01(\tR\x0freceiverVersion\"`\n" +
	"\bWorkload\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x1c\n" +
	"\tnamespace\x18\x02 \x01(\tR\tnamespace\x12\x0e\n" +
	"\x02ip\x18\x03 \x01(\tR\x02ip\x12\x12\n" +
	"\x04port\x18\x04 \x01(\x05R\x04port\"\x93\x01\n" +
	"\aRequest\x128\n" +
	...
	"\x18backend_latency_in_nanos\x18\x03 \x01(\x04R\x15backendLatencyInNanos\x1a:\n" +
	"\fHeadersEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	...
	"\x0fGetEnvoyMetrics\x12\x14.protobuf.ClientInfo\x1a\x16.protobuf.EnvoyMetrics0\x01B0Z.github.com/accuknox/SentryFlow/protobuf/golangb\x06proto3"
